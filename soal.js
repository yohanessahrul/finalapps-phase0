var quiz = [
    ...
    {question: "Jumlah kepercayaan / agama sah di Indonesia", opt: ['1/2 Agama', '5 Agama', '3 Agama', '12 Agama'], answer: '5 Agama' },
    {question: "Presiden Amerika saat ini?", opt: ['Cihuyman', 'Barrack Obama', 'Pak Tarno', 'Donald Trump'], answer: 'Donald Trump' },
    {question: "Vitamin A sangat baik untuk organ tubuh, terutama..", opt: ['Mata', 'Lambung', 'Rambut', 'Hidung'], answer: 'Mata' },
    {question: "Selain musim kemarau, Indonesia mempunyai musim?", opt: ['Musim Semi', 'Musim Alay', 'Musim Rambutan', 'Musim Hujan'], answer: 'Musim Hujan' }
  ];